...
<template>
    <div class="wall mt-4 d-block">
        <div class="container-sm rounded border d-flex m bg-white w-75">
            <div class="p-1">
            ...
            <label class="btn d-flex justify-content-center my-auto bg-light" for="customFile">
            ...
            <button type="button" class="btn btn-primary my-auto ms-1" @click.prevent="submitPost">Post</button>
        </div>
