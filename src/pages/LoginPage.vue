...
const methods = {
  checkIdentifiers: function (event) {
    ...
    if (this.email !== "louis@louis.com") throw new Error("Invalid email");
  ...
  <div class="tab-pane fade show active " id="pills-login " role="tabpanel" aria-labelledby="tab-login">
    <form>
      ...
      <div class="form-outline mb-4">
        <input type="email" id="loginName" class="form-control" placeholder="example@example.com" v-model="email"/>
        <label class="form-label" for="loginName">Email or email</label>
      </div>
